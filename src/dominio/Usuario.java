...
public class Usuario extends Persona implements Serializable {
  ...
  public Usuario() {
    ...
    this.setFotoPerfil(new ImageIcon(getClass()
  ...
  public void setSexo(String sexo) {
    if (SEXO_MASCULINO.equals(sexo) || SEXO_FEMENINO.equals(sexo)) {
      this.sexo = sexo;
    }
  }

  public boolean[] getListaRestricciones() {
    return listaRestricciones.clone();
  }

  public void setListaRestricciones(boolean[] listaRestricciones) {
    this.listaRestricciones = listaRestricciones.clone();
  }
